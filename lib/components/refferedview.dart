...
class refferedDetails extends StatefulWidget {
  final ViolationRecord record;
  final bool isEditable;

  const refferedDetails({
    super.key,
  ...
  @override
  State<refferedDetails> createState() => _ViolationDetailsState();
}

class _ViolationDetailsState extends State<refferedDetails> {
